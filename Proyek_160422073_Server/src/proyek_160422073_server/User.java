...
public class User {
    ...
    // Constructor
    public User(String fullname, String username, String password, String email, String phoneNumber, Date dob) {
        this.fullname = fullname;
        this.username = username;
        this.password = password;
        this.email = email;
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            // Create User object
            //User user = new User(fullname, username, password, email, phoneNumber, dob);
            // Display user data
//            System.out.println("\nUser Information:");
